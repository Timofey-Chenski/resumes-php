...
<body>
   ...
   <section class="resume-form">
      <form action="./send-res-to-db.php" method="post">
         <div class="container">
            <div class="row">
               <div class="col-md">
                  <div class="card">
                     ...
                     <div class="card-body">
                        <div class="d-flex justify-content-around">
                           ...
                           <div class="profile-input">
                              ...
                              <input type="text" placeholder="Введите имя" class="form-control" name="firstname" id="firstname">
                              ...
                              <input type="text" placeholder="Введите отчество" class="form-control" name="patronymic" id="patronymic">
                           </div>
                           <div class="profile-input">
                              ...
                              <input type="text" placeholder="Введите город" class="form-control" name="current_city" id="current_city">
                              <label for="citizenship" class="form-label">Гражданство</label>
                              <input type="text" placeholder="Введите гражданство" class="form-control" name="citizenship" id="citizenship">
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="card-body">
                        <div class="d-flex justify-content-around">
                           <div class="profile-input">
                              ...
                              <input type="email" placeholder="zakharoff@mail.ru" class="form-control" name="email" id="email">
                           </div>
                           <div class="profile-input">
                              <label for="phone" class="form-label">Телефон</label>
                              <input type="text" placeholder="+7 (999)-999-99-99" class="form-control" name="phone" id="phone">
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="card-body">
                        ...
                        <div class="d-flex justify-content-around line">
                           <div class="profile-input">
                              ...
                              <input type="date" class="form-control" name="beginning_work" id="beginning_work">
                           ...
                           <div class="profile-input">
                              ...
                              <input type="date" class="form-control" name="end_work" id="end_work">
                              <label for="company" class="form-label">Введите название компании</label>
                              <input type="text" placeholder="Название компании" class="form-control" name="company" id="company">
                           </div> 
                        </div>
                     ...
                     <div class="card-body">
                        ...
                        <div class="d-flex justify-content-around line">
                           <div class="profile-input">
                              ...
                              <input type="text" placeholder="Название" class="form-control" name="name_institution" id="name_institution">
                              <label for="faculty" class="form-label">Факультет</label>
                              <input type="text" placeholder="Факультет" class="form-control" name="faculty" id="faculty">
                              <label for="year_graduation" class="form-label">Год окончания</label>
                              <input type="date" class="form-control" name="year_graduation" id="year_graduation">
                           </div>
                           <div class="profile-input">
                              <label for="level_education" class="form-label">Уровень образования</label>
                              <select class="form-select" aria-label="Default select example" name="level_education" id="level_education">
                              ...
                              <input type="text" placeholder="Специальность" class="form-control" name="speciality" id="speciality">
                           </div>
                        </div>
                     ...
                     <div class="card-body">
                        ...
                        <div class="d-flex justify-content-around line">
                           <div class="profile-input">
                              ...
                              <input type="text" placeholder="Название курса" class="form-control" name="course_name" id="course_name">
                           ...
                           <div class="profile-input">
                              ...
                              <input type="text" placeholder="Организация" class="form-control" name="host_organization" id="host_organization">
                           </div>
                        </div>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center line">
                           <div class="resume-title">
                              <h5 class="d-flex align-items-center"><img src="./img/resume-list-wrap/lang.PNG" class="mb-1 mt-2 ms-2" alt="sport"></h5>
                           </div>
                           <div class="resume-icon d-flex align-items-center">
                              <img src="./img/resume-list-wrap/line.png" alt="line">
                              <img src="./img/resume-list-wrap/delete.png" alt="delete">
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        ...
                        <div class="profile-input line">
                           ...
                           <input type="text" placeholder="Навык" class="form-control ms-2" name="skill_description" id="skill_description">
                        </div>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        ...
                        <div class="line">
                           ...
                           <input type="text" placeholder="Качество" class="form-control ms-2" name="quality" id="quality">
                        </div> 
                     ...
                     <div class="card-body">
                        ...
                        <div class="d-flex justify-content-around line">
                           <div class="profile-input">
                              ...
                              <input type="text" placeholder="Название" class="form-control" name="activity_name" id="activity_name">
                     ...
                     <div class="card-body">
                        ...
                        <div class="d-flex justify-content-around line">
                           <div class="profile-input">
                              ...
                              <input type="text" placeholder="Название" class="form-control" name="publication_title" id="publication_title">
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        <textarea class="form-control" name="about_myself" id="about_myself" rows="3"></textarea>
                     </div>
                  </div>
                  <div class="d-flex justify-content-center">
                     <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Сохранить</button>
